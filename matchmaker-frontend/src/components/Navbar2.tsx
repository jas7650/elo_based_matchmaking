...
import { Menu, Landmark, CalendarPlus2 } from "lucide-react";
  ...
  menu = [
    { title: "Home", url: "/" },
    {
      ...
      items: [
        {
          title: "Group",
          description: "Create a new pickup group",
          icon: <Landmark className="size-5 shrink-0" />,
          url: "/newGroup",
        },
        {
          title: "Session",
          description: "Create a new pickup session",
          icon: <CalendarPlus2 className="size-5 shrink-0" />,
          url: "/newSession",
        },
      ],
    },
